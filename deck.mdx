...
<ul style={{ textAlign: "left" }}>
  <li>It generates HTML pages (files) at run/build time</li>
  <li>
...
<Flex>
  <Item width="50">
    <ul>
      <li>You can build both static or dynamic app.</li>
      <li>Use different Data sources or file formats to manage content.</li>
      <li>
        You could also easily implement different services for
        search/auth/cart/payments etc... using Gatsby plugins.
      </li>
    </ul>
  </Item>
  <Item width="50">
...
<Flex>
  ...
  <Item width="50">
    ...
    <ul>
      <li>
        Does Not generate new files on demand but does it during run/build time
...
Building a To do app connected to a REST API
